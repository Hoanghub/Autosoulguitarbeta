...
local Window = Fluent:CreateWindow({
    Title = "DarkzHub | BloxFruit",
    SubTitle = "by Darkiuuem",
    TabWidth = 160,
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
	...
	spawn(function()
        ...
        local ToggleSoulguitar = Tabs.Main:AddToggle("ToggleSoulguitar", {Title = "Auto Soulguitar", Default = false })
        ToggleSoulguitar:OnChanged(function(Value)
            _G.Soulguitar = Value
        end)
        Options.ToggleSoulguitar:SetValue(false)
